<?php /*a:2:{s:81:"G:\workspace\guanke\domain_front\application/wechat/view\manage\member\index.html";i:1510591756;s:77:"G:\workspace\guanke\domain_front\application/manage\view\template\iframe.html";i:1510315358;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="view-page">
    ...
    <div class="page-content">
		<form name="formSearch" class="form-search form-inline" method="get" action="index">
		    <input type="text" name="keywords" id="keywords" class="form-control input-sm" value="<?php echo (htmlentities(app('request')->get('keywords'))) ? htmlentities(app('request')->get('keywords')) : ''; ?>" placeholder="会员名称，手机号" />
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr >
                    ...
                    <td><?php echo htmlentities($item['openid']); ?></td>
                    <td><?php echo htmlentities($item['city']); ?></td>
                    <td>	                    
					...
					<td>
						<button type="button" class="btn btn-xs status-btn" data-init-val="<?php echo htmlentities($item['status']); ?>" data-url="statusChange.html" data-id="<?php echo htmlentities($item['id']); ?>" data-field="status"  data-status0="封停" data-status0-css="btn-none" data-status1="正常" data-status1-css="btn-success"  title="点击是否显示"></button>
					</td>
