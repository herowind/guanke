<?php /*a:2:{s:81:"G:\workspace\guanke\domain_front\application/guanke/view\manage\school\index.html";i:1510594546;s:77:"G:\workspace\guanke\domain_front\application/manage\view\template\iframe.html";i:1510315358;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="view-page">
    ...
    <div class="page-content">
		<form name="formSearch" class="form-search form-inline" method="get" action="index">
		    <input type="text" name="keywords" id="keywords" class="form-control input-sm" value="<?php echo (htmlentities(app('request')->get('keywords'))) ? htmlentities(app('request')->get('keywords')) : ''; ?>" placeholder="学校名称" />
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr >
                    ...
                    <td class="text-center"><img src="<?php echo htmlentities($item['logo']); ?>" width="40" height="40"/></td>
                    <td><?php echo htmlentities($item['name']); ?></td>
                    <td class="text-center"><?php echo htmlentities($item['typetext']); ?></td>
                    <td>	                    
                    ...
                    <td class="text-center"><?php echo htmlentities($item['update_time']); ?></td>
                    <td class="text-center">
						...
						<a class="text-orange btn btn-xs btn-default" href="/guanke/manage.liveschool/edit?school_id=<?php echo htmlentities($item['id']); ?>"   title="安装监控"><i class="fa fa-video-camera"></i> 安装监控</a>
