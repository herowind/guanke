<?php /*a:2:{s:81:"G:\workspace\guanke\domain_front\application/guanke/view\manage\course\index.html";i:1510583601;s:77:"G:\workspace\guanke\domain_front\application/manage\view\template\iframe.html";i:1510315358;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="view-page">
    <!-- 页面标题 -->
    <div class="page-head">
        <h6 class="padding-left page-head-title">课程查询
    ...
    <div class="page-content">
		<form name="formSearch" class="form-search form-inline" method="get" action="index">
			<select name="type" id="type" class="form-control input-sm" data-default="请选择课程类型">
		    ...
		    <input type="text" name="keywords" id="keywords" class="form-control input-sm" value="<?php echo (htmlentities(app('request')->get('keywords'))) ? htmlentities(app('request')->get('keywords')) : ''; ?>" placeholder="关键字：课程名称" />
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th class=" w5 ">序号</th>
                    <th class=" w10 text-center ">图片</th>
            ...
            <tbody>
                ...
                <tr >
                    ...
                    <td class="text-center"><img src="<?php echo htmlentities($item['banner']); ?>" width="80" height="40"/></td>
                    <td><?php echo htmlentities($item['name']); ?></td>
                    <td><?php echo htmlentities($item['typetext']); ?></td>
                    <td><?php echo htmlentities($item['totalfee']); ?>元</td>
                    <td>	                    
                    ...
                    <td class="text-center">
                        ...
                        <a class="text-orange btn btn-xs btn-default" href="/guanke/manage.livecourse/edit?course_id=<?php echo htmlentities($item['id']); ?>"   title="编辑"><i class="fa fa-video-camera"></i> 创建直播</a>
                    </td>
                </tr>
