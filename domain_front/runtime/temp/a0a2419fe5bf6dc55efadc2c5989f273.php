<?php /*a:1:{s:82:"G:\workspace\guanke\domain_front\application/zhibo/view\manage\camera\preview.html";i:1510595803;}*/ ?>
<div class="modal-header">
	<button type="button" class="close" data-dismiss="modal">
		<span aria-hidden="true">&times;</span><span class="sr-only">关闭</span>
	</button>
	<h4 class="modal-title">直播预览-<?php echo htmlentities($camera['name']); ?></h4>
</div>
<div class="modal-body">
	<div id="player" style="width: 565px; height: 280px; "></div>
</div>
